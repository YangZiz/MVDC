...
Mutil_G_optimizer = optim.Adam(Mutil_Generator.parameters(),lr=0.0002,betas=(0.5,0.999))
...
for epoch in range(now_epoch,epochs):
    ...
    for data in train_loader:
        ...
        up_fake, _, _ = Mutil_Generator(up, left, right)
        ...
        _, left_fake, _ = Mutil_Generator(up, left, right)
        ...
        _,_, right_fake =  Mutil_Generator(up, left, right)
        ...
        mutil_G_train_loss = -1*(up_D_fake_loss+left_D_fake_loss+right_D_fake_loss)-(up_LD_fake_loss+left_LD_fake_loss+right_LD_fake_loss)+ L1_lambda*(criterionL1(up_G_result,gt_up) + criterionL1(left_G_result,gt_left)+ criterionL1(right_G_result, gt_right))+10*up_con_loss#+ Lgro_lambda*criterionL1(Gro_fake,Gro_real)#+Lpg_lambda*loss_PG##
