...
def calculate_image_rmse(predicted_path, actual_path,inp_path):
    ...
    inp_image = Image.open(inp_path).convert('L')
...
gt_root = r'E:\teeth_data\depth_map\2_object'
output_root = r'C:\Users\Henry Su\Desktop\11_22test\3_2_pix2pix_test'
inp_root = r'E:\teeth_data\multi_view\depth_map\up\5_inp'
rmses = []
for id in os.listdir(output_root):
    gt_path = os.path.join(gt_root,id)
    output_path = os.path.join(output_root,id)
    inp_path = os.path.join(inp_root,id)
