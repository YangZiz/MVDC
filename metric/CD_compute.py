...
test_root = r'E:\research\code\sa-ifn\root_reconstruction\yaguan'
test_list = [13,21,29,44]
L1 = []
L2 = []
for id in test_list:
    ...
    gt_mesh = trimesh.load(r'E:\research\code\sa-ifn\root_reconstruction\yaguan\gt/{}_gt_scaled.off'.format(str(id)))
    ...
    idx = farthest_point_sample(batches, 30000)
    downsampled_points = batches[0][idx]
    downsampled = downsampled_points.view(30000, 3)
